...
class TuesdayTasks extends StatefulWidget {
  const TuesdayTasks({super.key});

  @override
  State<TuesdayTasks> createState() => _TuesdayTasksState();
}

class _TuesdayTasksState extends State<TuesdayTasks> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(child: Text('TO DO FOR TUESDAY')),
        elevation: 0,
      ),
      drawer: Drawer(
        child: ListView(
