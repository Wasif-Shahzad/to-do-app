...
class FridayTasks extends StatefulWidget {
  const FridayTasks({super.key});

  @override
  State<FridayTasks> createState() => _FridayTasksState();
}

class _FridayTasksState extends State<FridayTasks> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Center(child: Text('TO DO FOR FRIDAY')),
        elevation: 0,
      ),
      drawer: Drawer(
        child: ListView(
